      ...
      <div className="relative py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {/* Feature 1 */}
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Criação Intuitiva</h3>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Teste em Tempo Real</h3>
              <p className="text-sm sm:text-base text-white/60">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Otimização Inteligente</h3>
              <p className="text-sm sm:text-base text-white/60">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Versionamento</h3>
              <p className="text-sm sm:text-base text-white/60">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Análise de Documentos</h3>
              <p className="text-sm sm:text-base text-white/60">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-white/10 hover:border-emerald-500/50 transition-all">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Assistente por Voz</h3>
              <p className="text-sm sm:text-base text-white/60">
      ...
      <footer className="border-t border-white/5 py-6 sm:py-8">
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="text-center text-white/60">
            ...
            <p className="text-xs sm:text-sm mt-2">Feito com ❤️ usando React + TypeScript + Vite</p>
          </div>
        </div>
      </footer>
    </div>
